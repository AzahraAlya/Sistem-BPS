...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div class="content-wrapper">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Pengelolaan Mitra</h4>
                    <form class="forms-sample" action="/admin/manage/accounts/user/save" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                            <input type="hidden" class="form-control form-control-lg" name="role" placeholder="" value = 0>
                            </div>
                        </div>
