                    ...
                    <div class="col-lg-12">
                        <div class="p-3">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Ubah Password Pengawas</h1>
                            </div>
                            ...
                            <form class="user" action = "/setting" method="post">
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" readonly id="KODE_PETUGAS" value="<?= $pengawas['KODE_PETUGAS'] ?>">
                                </div>
